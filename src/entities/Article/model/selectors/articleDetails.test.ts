...
describe('articleDetails.test', () => {
  test('getArticleDetailsData returns article data', () => {
  ...
  test('getArticleDetailsError returns article error', () => {
    const state: DeepPartial<StateSchema> = { articleDetails: { error: 'error123' } };
    expect(getArticleDetailsError(state as StateSchema)).toBe('error123');
  });

  test(' getArticleDetailsError works with empty state', () => {
    const state: DeepPartial<StateSchema> = {};

    expect(getArticleDetailsError(state as StateSchema)).toBe(undefined);
  });

  test('getArticleDetailsIsLoading returns article data', () => {
  ...
  test('getArticleDetailsIsLoading works with empty state', () => {
    const state: DeepPartial<StateSchema> = {};
